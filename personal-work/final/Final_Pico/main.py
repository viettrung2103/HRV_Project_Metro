...
from opt11 import Opt11, Opt11_Mean_Program, Opt11_Display

from opt20 import Opt20, Opt20_Display
from opt21 import Opt21, Opt21_Mean_Program, Opt21_Display
...
from opt30 import Opt30, Opt30_Display
from opt31 import Opt31, Opt31_Mean_Program, Opt31_Display
...
opt21_display = Opt21_Display(I2C_MODE,SCL_PIN,SDA_PIN ,FREQ, OLED_WIDTH, OLED_HEIGHT)
opt21_mean_program = Opt21_Mean_Program(step)
opt21 = Opt21("21", opt21_display,opt21_mean_program, test_sample_size, sample_size,frequency, encoder,samples)
...
opt31_display = Opt31_Display(I2C_MODE,SCL_PIN,SDA_PIN ,FREQ, OLED_WIDTH, OLED_HEIGHT)
opt31_mean_program = Opt31_Mean_Program(step)
opt31 = Opt31("31", opt31_display,opt31_mean_program, test_sample_size, sample_size,frequency, encoder,samples)
