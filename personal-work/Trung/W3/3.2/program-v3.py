...
class Encoder:
    def __init__ (self, rot_a_pin, rot_b_pin, rot_sw_pin,selector):
        ...
        self.press_state = 1
        self_prev_time = 0 # to compare delta between to button press
    ...
    def turn_handler(self,pin):
        # save timestampe after every press, compare delta between 2 timestamp, if it more, put data to fifo
#         if delta >= 20:
